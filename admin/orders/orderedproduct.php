	...
	"post">
       ...
       <div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		<p align="right">Total Price :  <?php echo number_format($subtot,2);?> FCFA</p>
		  		<p align="right">Delivery Fee :  <?php echo number_format($cur->DELFEE,2); ?> FCFA</p>
		  		<p align="right">Overall Price : <?php echo number_format($cur->PAYMENT,2); ?> FCFA</p>
		  	</div>
		  </div> 
		</div>   
