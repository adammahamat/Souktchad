        ...
        <div class="panel panel-default">
          <div class="panel-body">  
            ...
            <form action="index.php?view=orderdetails" method="post">
                   ...
                   <tbody > 
                          ...
                          ?>
                                    <tr>
                                      ...
                                      <td> <?php echo  $result->PRICE ?> FCFA</td>
                                      <td>
                                      <input type="NUMBER" data-id="<?php echo $result->PRODUCTID;  ?>" class="qty" name="QTY<?php echo $result->PRODUCTID;  ?>" id="QTY<?php echo $result->PRODUCTID; ?>"  value="<?php echo $_SESSION['fixnmix_cart'][$i]['qty'] ?>"/>
                                        ...
                                        <td>
                                         <output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price']; ?></output> FCFA
                                        </td>
                                      <!-- hidden textbox -->
              ...
              <table>
           <tfoot  >
                    <div ><strong><h1 align="right" >Total Price : <span id="sum">0</span> FCFA</h1></strong></td></div>
               ...
               <button type="submit" name="proceed" class="btn btn_fixnmix pull-right"   ><strong>Proceder et commander</strong> <span class="glyphicon glyphicon-chevron-right"></span></button>
            </form>
       </fieldset>
          </div>    
        </div>
