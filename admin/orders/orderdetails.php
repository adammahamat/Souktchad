      ...
      <div class="">
        <div class="panel panel-default">
          <div class="panel-body">  
             ...
             <tfoot><tr><td></td></tr></tfoot>
              ...
              ?>
                         ...
                         <td></td>
                          ...
                          <td> <output><?php echo $_SESSION['fixnmix_cart'][$i]['price']?></output> FCFA</td>
                        </tr>
              <?php
                        }
            ...
            <div class="container"> 
              <div class="row"> <h3  align="right" margin-right="20%">Total Price : <span  id="sum">0.00</span></h3> FCFA</div>
                </div>
