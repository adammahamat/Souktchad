...
<section id="cart_items">
    ...
    <input type="hidden" value="<?php echo $res->AUTO; ?>" id="ORDEREDNUM" name="ORDEREDNUM">
      Numero de commande :<?php echo $res->AUTO; ?>
    </div>
    </div>
 </div>
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td> <?php echo  $result->PRODISPRICE ?> FCFA</td>
                          <td> <output><?php echo $_SESSION['gcCart'][$i]['price']?></output> FCFA</td>
                        </tr>
              <?php
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div >  Prix Total :    <span id="sum">0.00</span> FCFA</div>
                   <div > Frais de Delivraison : <span id="fee">0.00</span> FCFA</div>
                   <div>  Prix Global :  <span id="overall"><?php echo $tot ;?></span> FCFA</div>
      ...
      <div class="row">
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                      <label >
                          <input type="radio"  class="paymethod" name="paymethod" id="deliveryfee" value="Paiement a la delivraison" checked="true" data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >Paiement a la delivraison
                        ...
                        <div class="panel"> 
                                <div class="panel-body">
                                    <div class="form-group ">
                                      <label>Adresse de delivraison</label>

                                    
                                        <div class="col-md-12">
                                          <label class="col-md-4 control-label" for=
                                          "PLACE">Adresse / Ville :</label>
...
<br/>
              <div class="row">
                <div class="col-md-6">
                    <a href="index.php?q=cart" class="btn btn-default pull-left"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Voir panier</strong></a>
                   </div>
                  <div class="col-md-6">
                      <button type="submit" class="btn btn-pup  pull-right " name="btn" id="btn" onclick="return validatedate();"   /> Soumettre la commande <span class="glyphicon glyphicon-chevron-right"></span></button>
                </div>  
              </div>
