    ...
    <div class="col-sm-3">
        <div class="panel">
            <div class="panel-body">
                ...
                "Telecharger une image de profil"></a>
            </div>
            <ul class="list-group">
            <!-- <li class="list-group-item text-muted">Profile</li> -->
                <li class="list-group-item text-right"><span class=
                "pull-left"><strong>Nom et Prenoms</strong></span>
                <?php echo $res->FNAME .' '.$res->LNAME; ?></li>
                <li class="list-group-item text-right"> 
                <div class="panel-group" id="accordion">   
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"  >Changer le  mot de passe</a>
                  <div id="collapseTwo" class="panel-collapse collapse">
                    <div class="panel-body">
                        <form action="<?php echo web_root; ?>customer/controller.php?action=changepassword" method="POST"> 
                          <input type="password" class="form-control" name="CUSPASS" required placeholder="Nouveau mot de passe"><br/>
                          <input class="btn btn-sm btn-primary" type="submit" name="save"  value="Changer">
                        </form>
                      </div>
                  </div>
                </div> 
        ...
        <div class="panel">
            <div class="panel-body">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active">
                        <a data-toggle="tab" href="#home">La liste de commandes</a>
                    </li> 
                    <li>
                        <a data-toggle="tab" href="#settings">Changer vos donnes</a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#wishlist">Favoris</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane active" id="home">
                        ...
                        <div class="table-responsive" style="margin-top:5%;">
                            ...
                            <a href="#"  title="View list Of ordered products"  class="orderid   "  data-target="#myOrdered" data-toggle="modal" data-id="<?php echo  $result->ORDEREDNUM; ?>"><i class="fa fa-info-circle fa-fw"></i> view orders</a> 
                                            ...
                                            <td>
                                            <?php echo  $result->PAYMENT; ?> FCFA</td>
                                            <td>
                                            ...
                                            <td class="tooltip-demo">
                                                ...
                                                "tooltip tooltip.top">vue</span></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    "button">×</button>
                    <h4 class="modal-title" id="myModalLabel">Choisir une
                    Image.</h4>
                </div>
                ...
                "multipart/form-data" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        "btn btn-pup" name="savephoto" type="submit">Telecharger une
                        Photo</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
