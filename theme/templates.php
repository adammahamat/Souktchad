          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +235 63 63 57 40</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> info@souktchad.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-8 clearfix">
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                <li><a href="<?php echo web_root;?>index.php?q=cart"><i class="fa fa-shopping-cart"></i> panier</a></li>
                <?php if (isset($_SESSION['CUSID'] )) { ?>  
                  <li><a href="<?php echo web_root?>index.php?q=profile"><i class="fa fa-user"></i> Creer un compte</a></li>
                  <li><a   href="<?php echo web_root?>logout.php"><i class="fa fa-lock"></i> Quitter</a></li>
                <?php }else{ ?>
                <li><a data-target="#smyModal" data-toggle="modal"  href=""><i class="fa fa-lock"></i> Connectez-vous</a></li>
              <?php } ?>
              </ul>
            </div>
          </div>
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                <li><a href="<?php echo web_root;?>" class="active">Accueil</a></li>
                ...
                <li><a href="<?php web_root?>index.php?q=product">Produicts</a></li>
                <li><a href="<?php web_root?>index.php?q=contact">Contactez-nous</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
    ...
    <div class="footer-widget">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              <h2>A propos de Souktchad</h2>
              <ul class="nav nav-pills nav-stacked">
                <li><a href="#">Informations sur la societe</a></li>
                <li><a href="#">Carrieres</a></li>
                <li><a href="#">Emplacement du magasin</a></li>
                <li><a href="#">Programme d'ffilliation </a></li>
