    ...
    <div class="col-md-12 col-sm-8 content">  
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default panel-shadow">
                    ...
                    <div class="table-responsive">
                         ...
                         <body onload=" totalprice(); ">
                              ...
                              <form id="form" action="cart/controller.php?action=edit" method="POST"  
                                  ...
                                  <div class="column4">                                  
                                    ...
                                    <!-- <div style="float: right; width:100px"></div> -->
                                     <div style="float: left; width:50px">&nbsp;&nbsp;<span id="price1"><?php echo $result->PRICE; ?></span> FCFA</div>
                                     <div  id="test" style="float: right; width:50px"><output name="TOTAL" for="QTY price"></output> FCFA</div>
                                  </div>
                              </form> 
                            ...
                            <tr >  
                            <td>                               
                             <div class="culomn4"><div style="float: right;"><h1> Total Price : <span id="sum">0</span></h1> FCFA</div></div>
                            </td>                        
                ...
                <a href="index.php?page=2" class="btn btn-default pull-left"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Ajouter une nouvelle commande</strong></a>
                <a href="index.php?page=7" name="proceed"  class="btn btn_fixnmix pull-right"   ><strong>Proceder et commander</strong> <span class="glyphicon glyphicon-chevron-right"></span></a>
