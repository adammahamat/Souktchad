 <section id="advertisement">
    <div class="container">
      <img src="images/shop/advertisements.jpg" alt="" />
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->z
                  ...
                  <ul class="nav nav-pills nav-justified">
                   <li>
                            ...
                            if (isset($_SESSION['CUSID'])){  
                              ...
                              echo ' <a href="'.web_root. 'customer/controller.php?action=addwish&proid='.$result->PROID.'" title="Ajouter au favoris"><i class="fa fa-plus-square"></i>Ajouter au favoris</a></a>
                            ';

                             }else{
                               echo   '<a href="#" title="Ajouter au favoris" class="proid"  data-target="#smyModal" data-toggle="modal" data-id="'.  $result->PROID.'"><i class="fa fa-plus-square"></i>Ajouter au favoris</a></a>
                            ';
                            }  
                            ?>
       ...
       <?php  } 
              ...
              echo '<h1>Aucun produit n\'est diponible</h1>';
