...
// VALIDATE CUSTOMER
 ...
 // Validates Personal Info
   $(document).on("click", ".submit", function () { 
        ...
        if(FNAME.value==""){
           alert("Entrez votre Prenoms!");
             return false;
        }
        if(LNAME.value=="") {
           alert("Entrez votre Noms!");
             return false;
        }

        if(CITYADD.value=="") {
           alert("Entrez votre Address!");
             return false;
        }
        ...
        if(PHONE.value==""){
             alert("Entrez votre Numero de telephone!");
             return false;
        }
        // if(ZIPCODE.value==""){
        ...
        {
        alert ('S\'\ il vous plait accepter les termes et les conditions!');
        return false;
        }
